/*
 * Modifications: Copyright University of Basel, Graphics and Vision Research Group
 *
...
/*
 * This file is based on code from Apache Spark Mllib, EigenValueDecomposition.scala
