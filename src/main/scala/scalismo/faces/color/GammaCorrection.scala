 ...
 *
 * This implementation is consistent in round trip sRGB -> RGB and back (errors below 1e-16). The java internal
 * implementation is much less consistent (errors up to 0.06!)
 */
